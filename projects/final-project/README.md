...
- [ ] Include [basic web accessibility](https://github.com/Difmo/curriculum/blob/main/web/accessibility.md?plain=1). People should have no trouble with visual contrast, using zoom to magnify content, or navigating via screenreader or keyboard.
...
- [ ] Fork [the project template](https://github.com/Difmo/curriculum/blob/main/projects/2023TemplateWithVite/README.md).
