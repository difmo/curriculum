...
1. Apprentices will obtain code from Difmo staff by posting code in the #tech-help Difmo Slack channel and pinging and instructor.
...
Navigate to the `Difmo-labs` folder located in your Desktop.
Create a new folder called `getting-started-with-node` within the `Difmo-labs` folder.
