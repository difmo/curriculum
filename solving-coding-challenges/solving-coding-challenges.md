...
See [Testing lesson](https://github.com/Difmo/curriculum/blob/main/testing-and-tdd/testing-mindset.md)
...
Testing along the way can make debugging easier. See [Debugging Lesson](https://github.com/Difmo/curriculum/blob/main/debugging/debugging.md) for more info.
