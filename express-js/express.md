...
Let start the server using `node app.js` command on your terminal and to go to `http://localhost:3000/`, we will see **Hello Difmo! Requested at: 1642193239275** something like this.
