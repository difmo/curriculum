...
- Review the [Issues tagged with GSSoC](https://github.com/Difmo/curriculum/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+label%3Agssoc20+no%3Aassignee)
...
1. Find any unassigned open issue in [our backlog](https://github.com/Difmo/curriculum/projects/2)
...
- Choose an issue from the [TO-DO](https://github.com/Difmo/curriculum/projects/2) column that seems right for you & message Difmo staff. If you know someone connected to Difmo, they may be able to add you to our slack channel.
...
- To **edit a slideshow**, you'll need to request edit permission by clicking View Only > Request Edit Access, or message info@Difmo.org. If you are logged into an account ending in @gmail.com, you can simply make a copy, edit, and transfer ownership to Difmoorg@gmail.com when you finish. Either way, save on top of the sample template used in the slide, and cut any slides you find unnecessary.
